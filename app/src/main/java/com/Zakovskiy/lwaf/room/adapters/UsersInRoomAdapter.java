...
public class UsersInRoomAdapter extends ArrayAdapter<ShortUser> {
    private Context context;
    private List<ShortUser> users;
    private FragmentManager fragmentManager;

    public UsersInRoomAdapter(Context context, FragmentManager fragmentManager, List<ShortUser> users) {
