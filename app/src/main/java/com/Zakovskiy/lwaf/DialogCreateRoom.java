...
public class DialogCreateRoom extends Dialog {
    ...
    public void onCreate(Bundle bundle) {
        ...
        Boolean enabled_loto = this.context.getSharedPreferences("lwaf_user", 0).getBoolean("last_room_enabled_loto", true);
        CheckBox cbEnabledLoto = findViewById(R.id.cbEnableLoto);
        cbEnabledLoto.setChecked(enabled_loto);
        ...
        findViewById(R.id.button_submit).setOnClickListener(view -> {
            ...
            data.put(PacketDataKeys.LOTO_ENABLED, cbEnabledLoto.isChecked());
            ...
            ed.putBoolean("last_room_enabled_loto", cbEnabledLoto.isChecked());
            ed.apply();
